...
public class TurmaCalcularAmplitudeNotasProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext)
    ...
    return Stream.of(
          Arguments.of(List.of(ana, bruno, carlos, diana), 6.0),
          Arguments.of(List.of(unico), 0.0),
