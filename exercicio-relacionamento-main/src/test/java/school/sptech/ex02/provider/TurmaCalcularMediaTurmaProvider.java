...
public class TurmaCalcularMediaTurmaProvider implements ArgumentsProvider {
  ...
  public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext)
    ...
    return Stream.of(
          Arguments.of(List.of(ana, bruno, carlos, diana, elias), 6.9),
          Arguments.of(List.of(unico), 7.0),
